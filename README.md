...
It's always recommended to go through the official documentation in addition to this guides!
The scripts and commands in this guide are executed on a Linux jumpbox.
