...
def validate_fluent_bit_data_values():
  ...
  elif data.values.fluent_bit.output_plugin == "syslog":
    data.values.fluent_bit.syslog.host or assert.fail("missing syslog.host ")
    data.values.fluent_bit.syslog.port or assert.fail("missing syslog.port ")
    data.values.fluent_bit.syslog.mode or assert.fail("missing syslog.mode ")
    data.values.fluent_bit.syslog.format or assert.fail("missing syslog.format ")
  end
end
